...
cv2.createTrackbar("LH","Tracking",80,255,nothing)
...
while True:
    Original_image = cv2.imread("Images/Sample_check_2.png")
    image=Original_image[100:160,150:300]
    # 80,54,61 204,255,255
